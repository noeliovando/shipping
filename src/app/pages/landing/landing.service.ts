...
export class LandingService {
    ...
    getMenuItems() {
        return [ 'home',  'pricing', 'features', 'works', 'services', 'testimonials', 'contact' ];
    }
    ...
    getTestimonials() {
        return [
            {
                text: 'Phasellus sed metus leo. Donec laoreet, lacus ut suscipit convallis, ' +
                    'erat enim eleifend nulla, at sagittis enim urna et lacus. Etiam orci lacus, volutpat at egestas sit amet, ' +
                    'vestibulum sit amet eros.',
                author: 'Mr. Adam Sandler',
                company: 'General Electric',
                image: 'assets/img/profile/adam.jpg'
            },
            {
                text: 'Phasellus sed metus leo. Donec laoreet, lacus ut suscipit convallis, erat enim eleifend nulla, ' +
                    'at sagittis enim urna et lacus. Etiam orci lacus, volutpat at egestas sit amet, vestibulum sit amet eros.',
